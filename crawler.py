...
def scrape_url(url, max_depth, min_content_length):
    ...
    process.crawl(GeneralSpider, start_url=url, max_depth=max_depth, min_content_length=min_content_length)
    process.start()
    return url

def scrape_urls_parallel(urls, max_depth, min_content_length):
    with multiprocessing.Pool() as pool:
        scrape_func = partial(scrape_url, max_depth=max_depth, min_content_length=min_content_length)
